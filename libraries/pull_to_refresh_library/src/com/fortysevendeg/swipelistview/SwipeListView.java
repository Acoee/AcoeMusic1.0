...
public class SwipeListView extends ListView {
    ...
    protected void onClickFrontView(int position) {
        ...
        if(onFrontClickListener != null){
        	onFrontClickListener.onClickFrontView(position);
        }
    }
     ...
     * 单击前置项
     */
    private SwipeItemClickListener onFrontClickListener;
    public void onClickFrontView(SwipeItemClickListener onFrontClickListener){
    	this.onFrontClickListener = onFrontClickListener;
    }
